...
For GitHub Copilot, call Defuddle through terminal tools when a clean markdown extraction of a web page is more useful than raw HTML or a noisy browser fetch.
