...
Migrar el sistema util del sistema anterior a Obsidian local sin copiar la complejidad que hoy genera friccion.
...
| Origen anterior | Destino Obsidian | Decision |
|---|---|---|
...
En el sistema anterior tienes varias bases similares para `Book List`, `Anime List` y `Manga List`, pero no una base igual de clara para peliculas o series.
...
En el sistema anterior, `Tareas` tiene mucha potencia, pero tambien demasiada superficie:
...
Si una vista falla o no esta abierta, el sistema sigue siendo legible. Eso no pasa igual en el sistema anterior.
